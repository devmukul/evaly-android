...
public class BrandProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BrandProductAdapter(Context context, List<ProductItem> a, AppCompatActivity activityInstance, Fragment fragmentInstance, NavController navController, HashMap<String, String> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_PROGRESS) {
            ...
            View v = inflater.inflate(R.layout.recycler_header_brands, parent, false);
            return new BrandProductHeader(v, context, activityInstance, fragmentInstance, navController, data);
        } else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderz, int position) {
        if (holderz instanceof BrandProductHeader) {

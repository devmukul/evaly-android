...
public class AppointmentApiHelper extends BaseApiHelper {
    ...
    public static void createAppointmentComment(AppointmentCommentRequest body, ResponseListenerAuth<CommonDataResponse<AppointmentCommentResponse>, String> listener) {
        getiApiClient().createAppointmentComment(CredentialManager.getToken(), body).enqueue(getResponseCallBackDefault(listener));
    }

...
public class PasswordViewModel extends BaseViewModel {
    ...
    protected SingleLiveEvent<Void> successLiveData = new SingleLiveEvent<>();
    ...
    @Inject
    public PasswordViewModel(ApiRepository apiRepository, PreferenceRepository preferenceRepository) {
        this.apiRepository = apiRepository;
        this.preferenceRepository = preferenceRepository;
    }

    public void setPassword(HashMap<String, String> data) {

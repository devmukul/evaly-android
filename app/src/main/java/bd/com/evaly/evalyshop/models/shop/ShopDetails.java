...
public class ShopDetails {
	...
	private List<ShopDeliveryOptionsItem> shopDeliveryOptions;
	...
	public void setShopDeliveryOptions(List<ShopDeliveryOptionsItem> shopDeliveryOptions){
		this.shopDeliveryOptions = shopDeliveryOptions;
	}

	public List<ShopDeliveryOptionsItem> getShopDeliveryOptions(){

...
@Database(entities = {CategoryEntity.class, WishListEntity.class, BannerItem.class, ExpressServiceModel.class, AddressResponse.class}, version = 26, exportSchema = false)

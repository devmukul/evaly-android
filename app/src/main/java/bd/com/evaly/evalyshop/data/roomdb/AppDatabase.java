...
@Database(entities = {CategoryEntity.class, WishListEntity.class, BannerItem.class, ExpressServiceModel.class, AddressResponse.class}, version = 30, exportSchema = false)
